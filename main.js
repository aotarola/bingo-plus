...
Elm.Bingo.make = function (_elm) {
   ...
   "bingo!",
   3)]));
   var sortEntries = function (model) {
      ...
      return function () {
         ...
         {case "Add":
            return function () {
                 ...
                 model.nextID);
                 return isInvalid(model) ? model : sortEntries(_U.replace([["phraseInput"
                                                                           ,""]
                                                                          ,["pointsInput"
                                                                           ,""]
                                                                          ,["entries"
